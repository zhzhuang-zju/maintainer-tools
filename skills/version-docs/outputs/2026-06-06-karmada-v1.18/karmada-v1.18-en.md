...
Karmada v1.18 version includes 144 code commits from 31 contributors. We would like to express our sincere gratitude to all contributors:
...
[1] Karmada v1.18 Release Page: [https://github.com/karmada-io/karmada/releases/tag/v1.18.0](https://github.com/karmada-io/karmada/releases/tag/v1.18.0)
...
[3] Overflow Cluster Affinities Feature Documentation: [https://karmada.io/docs/userguide/scheduling/propagation-policy#how-overflowaffinities-works](https://karmada.io/docs/userguide/scheduling/propagation-policy#how-overflowaffinities-works)
...
[5] Scheduling Overcommit Protection Documentation and Proposal: [https://karmada.io/docs/userguide/scheduling/scheduling-overcommit-protection](https://karmada.io/docs/userguide/scheduling/scheduling-overcommit-protection), [https://github.com/karmada-io/karmada/blob/master/docs/proposals/scheduling/estimator-reservation/README.md](https://github.com/karmada-io/karmada/blob/master/docs/proposals/scheduling/estimator-reservation/README.md)
