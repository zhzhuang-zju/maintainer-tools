...
更多有关此功能的资料请参考：[官方特性文档](https://karmada.io/docs/userguide/scheduling/propagation-policy#how-overflowaffinities-works) 和 [特性 proposal](https://github.com/karmada-io/karmada/blob/master/docs/proposals/scheduling/multi-scheduling-group/overflow-affinities/README.md)。
...
为了解决这一问题，Karmada v1.18 引入了 **Scheduling Overcommit Protection（调度过量保护）**。该特性在调度器和估算器之间引入“assume and deduct（先假定、再扣减）”机制：
...
更多有关此功能的资料请参考：[Scheduling Overcommit Protection](https://karmada.io/docs/userguide/scheduling/scheduling-overcommit-protection)。
...
[1] Karmada v1.18 发布页: [https://github.com/karmada-io/karmada/releases/tag/v1.18.0](https://github.com/karmada-io/karmada/releases/tag/v1.18.0)

[2] Karmada v1.18 Release Note / Changelog: [https://github.com/karmada-io/karmada/blob/master/docs/CHANGELOG/CHANGELOG-1.18.md](https://github.com/karmada-io/karmada/blob/master/docs/CHANGELOG/CHANGELOG-1.18.md)

[3] Overflow Cluster Affinities 特性文档: [https://karmada.io/docs/userguide/scheduling/propagation-policy#how-overflowaffinities-works](https://karmada.io/docs/userguide/scheduling/propagation-policy#how-overflowaffinities-works)

[4] Overflow Cluster Affinities Proposal: [https://github.com/karmada-io/karmada/blob/master/docs/proposals/scheduling/multi-scheduling-group/overflow-affinities/README.md](https://github.com/karmada-io/karmada/blob/master/docs/proposals/scheduling/multi-scheduling-group/overflow-affinities/README.md)

[5] Scheduling Overcommit Protection 文档与 Proposal: [https://karmada.io/docs/userguide/scheduling/scheduling-overcommit-protection](https://karmada.io/docs/userguide/scheduling/scheduling-overcommit-protection), [https://github.com/karmada-io/karmada/blob/master/docs/proposals/scheduling/estimator-reservation/README.md](https://github.com/karmada-io/karmada/blob/master/docs/proposals/scheduling/estimator-reservation/README.md)
