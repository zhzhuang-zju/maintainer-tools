...
[1] Karmada v1.17: [https://github.com/karmada-io/karmada/blob/master/docs/CHANGELOG/CHANGELOG-1.17.md](https://github.com/karmada-io/karmada/blob/master/docs/CHANGELOG/CHANGELOG-1.16.md)

[2] 工作负载亲和性调度: [https://karmada.io/docs/next/userguide/scheduling/propagation-policy/\#workloadaffinity](https://karmada.io/docs/next/userguide/scheduling/propagation-policy/#workloadaffinity)

[3] Karmada Dashboard: [https://github.com/karmada-io/dashboard](https://github.com/karmada-io/dashboard)

[4] [Performance] optimize the mechanism of create or update dependencies-distribute resourcebinding: [https://github.com/karmada-io/karmada/pull/7153](https://github.com/karmada-io/karmada/pull/7153)
